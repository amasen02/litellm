...
@pytest.mark.parametrize(
    ...
    [
        ...
        ([_custom_prompt_row("a"), _custom_prompt_row("b"), _heuristic_v2_row("c", "heuristic")], "system_prompt"),
        ([_custom_tier_row("a"), _custom_prompt_row("b"), _heuristic_v2_row("c", "heuristic")], "tier_definitions or a custom classifier system_prompt"),
    ],
)
